<template>
    <div>
      <div class="dropdown-container">
        <input type="text" readonly @click="showDropdown = !showDropdown" v-model="selectedRegion" placeholder="충청남도">
    ...
    <div class="container">
     <div class="category-menu">
      ...
      <div class="large-category-item" v-for="category in chungcheongnamdo" :key="category.largeCode">
      ...
      <div class="region-container">
        <div class="image">
          <img src="../../assets/chungnam.jpg" alt="chungcheongnamdo"  height="350">
        </div>
          <div class="location-description">
            <span >
            <img id="icon" src="../../assets/location_icon.png" alt="Location Icon" style="vertical-align: middle; width: 2rem; height: 2rem;" >
            <span><h2>충청남도</h2></span>
          </span>
            <p>충청남도는 대한민국의 중부 지방에 위치한 지역으로, 지역 내에는 평야와 산지, 강과 호수 등이 풍부하게 분포하고 있습니다.
               충청남도는 대한민국의 중심부에 위치하여 교통의 요충지로서의 역할도 매우 중요합니다.
               충청남도의 중심지는 대전과 천안이며 다른 관광지로는 부여, 공주, 당진, 아산 등이 있습니다.</p>
        </div>
      </div>
  ...
  <script>
  import chungcheongnamdo from './data/chungcheongnamdo.js';
